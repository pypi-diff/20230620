# Comparing `tmp/metldata-0.3.0.tar.gz` & `tmp/metldata-0.3.1.tar.gz`
...
### Comparing `metldata-0.3.0/metldata/builtin_transformations/add_accessions/config.py` & `metldata-0.3.1/metldata/builtin_transformations/add_accessions/config.py`
...
### Comparing `metldata-0.3.0/tests/artifact_rest/test_query_resources.py` & `metldata-0.3.1/tests/artifact_rest/test_query_resources.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/builtin_tranformations/__init__.py` & `metldata-0.3.1/tests/builtin_tranformations/__init__.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/builtin_tranformations/infer_references/__init__.py` & `metldata-0.3.1/tests/builtin_tranformations/infer_references/__init__.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/builtin_tranformations/infer_references/path/__init__.py` & `metldata-0.3.1/tests/builtin_tranformations/infer_references/path/__init__.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/builtin_tranformations/infer_references/path/test_config.py` & `metldata-0.3.1/tests/builtin_tranformations/infer_references/path/test_config.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/builtin_tranformations/infer_references/path/test_path.py` & `metldata-0.3.1/tests/builtin_tranformations/infer_references/path/test_path.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/builtin_tranformations/infer_references/path/test_path_str.py` & `metldata-0.3.1/tests/builtin_tranformations/infer_references/path/test_path_str.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/builtin_tranformations/merge_slots/__init__.py` & `metldata-0.3.1/tests/builtin_tranformations/merge_slots/__init__.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/builtin_tranformations/merge_slots/test_config.py` & `metldata-0.3.1/tests/builtin_tranformations/merge_slots/test_config.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/builtin_tranformations/merge_slots/test_models.py` & `metldata-0.3.1/tests/builtin_tranformations/merge_slots/test_models.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/builtin_tranformations/test_happy.py` & `metldata-0.3.1/tests/builtin_tranformations/test_happy.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/builtin_workflows/__init__.py` & `metldata-0.3.1/tests/builtin_workflows/__init__.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/builtin_workflows/test_happy.py` & `metldata-0.3.1/tests/builtin_workflows/test_happy.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/fixtures/__init__.py` & `metldata-0.3.1/tests/fixtures/__init__.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/fixtures/artifact_info.py` & `metldata-0.3.1/tests/fixtures/artifact_info.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/fixtures/config.py` & `metldata-0.3.1/tests/fixtures/config.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/fixtures/event_handling.py` & `metldata-0.3.1/tests/fixtures/event_handling.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/fixtures/metadata.py` & `metldata-0.3.1/tests/fixtures/metadata.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/fixtures/metadata_models.py` & `metldata-0.3.1/tests/fixtures/metadata_models.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/fixtures/transformations.py` & `metldata-0.3.1/tests/fixtures/transformations.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/fixtures/utils.py` & `metldata-0.3.1/tests/fixtures/utils.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/fixtures/workflows.py` & `metldata-0.3.1/tests/fixtures/workflows.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/load/__init__.py` & `metldata-0.3.1/tests/load/__init__.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/load/test_client.py` & `metldata-0.3.1/tests/load/test_client.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/load/test_main.py` & `metldata-0.3.1/tests/load/test_main.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/model_utils/__init__.py` & `metldata-0.3.1/tests/model_utils/__init__.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/model_utils/test_anchor.py` & `metldata-0.3.1/tests/model_utils/test_anchor.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/model_utils/test_assumptions.py` & `metldata-0.3.1/tests/model_utils/test_assumptions.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/model_utils/test_config.py` & `metldata-0.3.1/tests/model_utils/test_config.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/model_utils/test_essentials.py` & `metldata-0.3.1/tests/model_utils/test_essentials.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/model_utils/test_identifiers.py` & `metldata-0.3.1/tests/model_utils/test_identifiers.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/model_utils/test_manipulate.py` & `metldata-0.3.1/tests/model_utils/test_manipulate.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/model_utils/test_metadata_validator.py` & `metldata-0.3.1/tests/model_utils/test_metadata_validator.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/submission_registry/__init__.py` & `metldata-0.3.1/tests/submission_registry/__init__.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/submission_registry/test_event_publisher.py` & `metldata-0.3.1/tests/submission_registry/test_event_publisher.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/submission_registry/test_identifiers.py` & `metldata-0.3.1/tests/submission_registry/test_identifiers.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/submission_registry/test_models.py` & `metldata-0.3.1/tests/submission_registry/test_models.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/submission_registry/test_submission_registry.py` & `metldata-0.3.1/tests/submission_registry/test_submission_registry.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/submission_registry/test_submission_store.py` & `metldata-0.3.1/tests/submission_registry/test_submission_store.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/test_event_handling.py` & `metldata-0.3.1/tests/test_event_handling.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/test_metadata_utils.py` & `metldata-0.3.1/tests/test_metadata_utils.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/transform/__init__.py` & `metldata-0.3.1/tests/transform/__init__.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/transform/test_base.py` & `metldata-0.3.1/tests/transform/test_base.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/transform/test_handling.py` & `metldata-0.3.1/tests/transform/test_handling.py`

 * *Files identical despite different names*

### Comparing `metldata-0.3.0/tests/transform/test_main.py` & `metldata-0.3.1/tests/transform/test_main.py`
