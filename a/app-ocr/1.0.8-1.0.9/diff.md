# Comparing `tmp/app_ocr-1.0.8.tar.gz` & `tmp/app_ocr-1.0.9.tar.gz`
...
### Comparing `app_ocr-1.0.8/PKG-INFO` & `app_ocr-1.0.9/PKG-INFO`
...
### Comparing `app_ocr-1.0.8/app/ocr/core/modules/passport/passport.py` & `app_ocr-1.0.9/app/ocr/core/modules/passport/passport.py`
...
### Comparing `app_ocr-1.0.8/app/ocr/core/tools/dictionaries.py` & `app_ocr-1.0.9/app/ocr/core/tools/dictionaries.py`

 * *Files identical despite different names*

### Comparing `app_ocr-1.0.8/app/ocr/core/tools/functional.py` & `app_ocr-1.0.9/app/ocr/core/tools/functional.py`

 * *Files identical despite different names*

### Comparing `app_ocr-1.0.8/setup.py` & `app_ocr-1.0.9/setup.py`
