# Comparing `tmp/satosa_oidcop-1.1.1.tar.gz` & `tmp/satosa_oidcop-1.1.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "satosa_oidcop-1.1.1.tar", last modified: Wed Jan 18 22:52:24 2023, max compression
+gzip compressed data, was "satosa_oidcop-1.1.2.tar", last modified: Tue Jun 20 13:24:27 2023, max compression
```

## Comparing `satosa_oidcop-1.1.1.tar` & `satosa_oidcop-1.1.2.tar`

### file list

```diff
@@ -1,26 +1,26 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-01-18 22:52:24.672487 satosa_oidcop-1.1.1/
--rw-r--r--   0 runner    (1001) docker     (123)    34523 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)     5961 2023-01-18 22:52:24.672487 satosa_oidcop-1.1.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     5397 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-01-18 22:52:24.672487 satosa_oidcop-1.1.1/satosa_oidcop/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/satosa_oidcop/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-01-18 22:52:24.672487 satosa_oidcop-1.1.1/satosa_oidcop/core/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/satosa_oidcop/core/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      886 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/satosa_oidcop/core/application.py
--rw-r--r--   0 runner    (1001) docker     (123)     1443 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/satosa_oidcop/core/claims.py
--rw-r--r--   0 runner    (1001) docker     (123)      392 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/satosa_oidcop/core/response.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-01-18 22:52:24.672487 satosa_oidcop-1.1.1/satosa_oidcop/core/storage/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/satosa_oidcop/core/storage/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      712 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/satosa_oidcop/core/storage/base.py
--rw-r--r--   0 runner    (1001) docker     (123)     7425 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/satosa_oidcop/core/storage/mongo.py
--rw-r--r--   0 runner    (1001) docker     (123)      554 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/satosa_oidcop/core/user_authn.py
--rw-r--r--   0 runner    (1001) docker     (123)      545 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/satosa_oidcop/core/user_info.py
--rw-r--r--   0 runner    (1001) docker     (123)    29825 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/satosa_oidcop/idpy_oidcop.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-01-18 22:52:24.672487 satosa_oidcop-1.1.1/satosa_oidcop.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     5961 2023-01-18 22:52:24.000000 satosa_oidcop-1.1.1/satosa_oidcop.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      575 2023-01-18 22:52:24.000000 satosa_oidcop-1.1.1/satosa_oidcop.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-01-18 22:52:24.000000 satosa_oidcop-1.1.1/satosa_oidcop.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       58 2023-01-18 22:52:24.000000 satosa_oidcop-1.1.1/satosa_oidcop.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       14 2023-01-18 22:52:24.000000 satosa_oidcop-1.1.1/satosa_oidcop.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       90 2023-01-18 22:52:24.672487 satosa_oidcop-1.1.1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1130 2023-01-18 22:51:35.000000 satosa_oidcop-1.1.1/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-20 13:24:27.587290 satosa_oidcop-1.1.2/
+-rw-r--r--   0 runner    (1001) docker     (123)    34523 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)     6180 2023-06-20 13:24:27.591290 satosa_oidcop-1.1.2/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)     5616 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/README.md
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-20 13:24:27.587290 satosa_oidcop-1.1.2/satosa_oidcop/
+-rw-r--r--   0 runner    (1001) docker     (123)       22 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/satosa_oidcop/__init__.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-20 13:24:27.587290 satosa_oidcop-1.1.2/satosa_oidcop/core/
+-rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/satosa_oidcop/core/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)      906 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/satosa_oidcop/core/application.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1443 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/satosa_oidcop/core/claims.py
+-rw-r--r--   0 runner    (1001) docker     (123)      392 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/satosa_oidcop/core/response.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-20 13:24:27.587290 satosa_oidcop-1.1.2/satosa_oidcop/core/storage/
+-rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/satosa_oidcop/core/storage/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)      712 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/satosa_oidcop/core/storage/base.py
+-rw-r--r--   0 runner    (1001) docker     (123)     7972 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/satosa_oidcop/core/storage/mongo.py
+-rw-r--r--   0 runner    (1001) docker     (123)      563 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/satosa_oidcop/core/user_authn.py
+-rw-r--r--   0 runner    (1001) docker     (123)      554 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/satosa_oidcop/core/user_info.py
+-rw-r--r--   0 runner    (1001) docker     (123)    31922 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/satosa_oidcop/idpy_oidcop.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-20 13:24:27.587290 satosa_oidcop-1.1.2/satosa_oidcop.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     6180 2023-06-20 13:24:27.000000 satosa_oidcop-1.1.2/satosa_oidcop.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      575 2023-06-20 13:24:27.000000 satosa_oidcop-1.1.2/satosa_oidcop.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-20 13:24:27.000000 satosa_oidcop-1.1.2/satosa_oidcop.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       58 2023-06-20 13:24:27.000000 satosa_oidcop-1.1.2/satosa_oidcop.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       14 2023-06-20 13:24:27.000000 satosa_oidcop-1.1.2/satosa_oidcop.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       90 2023-06-20 13:24:27.591290 satosa_oidcop-1.1.2/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)     1130 2023-06-20 13:23:58.000000 satosa_oidcop-1.1.2/setup.py
```

### Comparing `satosa_oidcop-1.1.1/LICENSE` & `satosa_oidcop-1.1.2/LICENSE`

 * *Files identical despite different names*

### Comparing `satosa_oidcop-1.1.1/PKG-INFO` & `satosa_oidcop-1.1.2/README.md`
...
### Comparing `satosa_oidcop-1.1.1/README.md` & `satosa_oidcop-1.1.2/PKG-INFO`
...
### Comparing `satosa_oidcop-1.1.1/satosa_oidcop/core/application.py` & `satosa_oidcop-1.1.2/satosa_oidcop/core/application.py`
...
### Comparing `satosa_oidcop-1.1.1/satosa_oidcop/core/claims.py` & `satosa_oidcop-1.1.2/satosa_oidcop/core/claims.py`

 * *Files identical despite different names*

### Comparing `satosa_oidcop-1.1.1/satosa_oidcop/core/storage/base.py` & `satosa_oidcop-1.1.2/satosa_oidcop/core/storage/base.py`

 * *Files identical despite different names*

### Comparing `satosa_oidcop-1.1.1/satosa_oidcop/core/storage/mongo.py` & `satosa_oidcop-1.1.2/satosa_oidcop/core/storage/mongo.py`
...
### Comparing `satosa_oidcop-1.1.1/satosa_oidcop/core/user_authn.py` & `satosa_oidcop-1.1.2/satosa_oidcop/core/user_authn.py`
...
### Comparing `satosa_oidcop-1.1.1/satosa_oidcop/core/user_info.py` & `satosa_oidcop-1.1.2/satosa_oidcop/core/user_info.py`
...
### Comparing `satosa_oidcop-1.1.1/satosa_oidcop/idpy_oidcop.py` & `satosa_oidcop-1.1.2/satosa_oidcop/idpy_oidcop.py`
...
### Comparing `satosa_oidcop-1.1.1/satosa_oidcop.egg-info/PKG-INFO` & `satosa_oidcop-1.1.2/satosa_oidcop.egg-info/PKG-INFO`
...
### Comparing `satosa_oidcop-1.1.1/satosa_oidcop.egg-info/SOURCES.txt` & `satosa_oidcop-1.1.2/satosa_oidcop.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `satosa_oidcop-1.1.1/setup.py` & `satosa_oidcop-1.1.2/setup.py`
